...
1. Under the Resource groups tab, launch **AVS-RG**.
...
15. Under **Get a Windows 11 development environment** click on **VMware** which will download a zip file named **WinDev2401 Eval.VMWare.zip**.
    ...
    >**Note**: Wait for the file to get downloaded it will take up to 30 mins.
...
1. Right click on **WinDev2401Evsl (1)**, and then select **New VM from This Template... (2)**.
   ...
   >**Note**: If you are not able to see New VM from This Template... option for 24 hours to get Wait **New VM from This Template...** option .
