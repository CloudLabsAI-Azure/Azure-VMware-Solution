...
1. Under Pick an account, select the ODL user Azure Connected Machine Agent.
...
1. On the Are you trying to sign in to Azure Connected Machine agent, select **Continue**.

   ![](../Images/avs-task2-20.png)

1. You will see new tab, Azure Connected Machine Agent where You have signed in to the Azure Connected Machine Agent application on your device.

   ![](../Images/avs-task2-21.png)

1. Return to the powershell to check if the powershell script has completed.
