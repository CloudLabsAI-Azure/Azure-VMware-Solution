![image](https://github.com/CloudLabsAI-Azure/Azure-VMware-Solution/assets/27498287/a13c1d53-1108-4204-954c-5e878df7fbb8)# Exercise 4: Deploy VMware VMs in AVS 
...
2. On the **Select a name and folder** pane; enter the Virtual machine name as **TestVM-<inject key="GET-DEPLOYMENT-ID" />** **(1)** and then Select a location for the virtual machine i.e. **SDDC-Datacenter (2)**, and then, click on **NEXT (3)**.
