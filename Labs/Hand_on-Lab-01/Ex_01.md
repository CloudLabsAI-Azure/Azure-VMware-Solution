...
4. Once you clicked on **save**, you will see the **Custom deployment** page. On this page, select/provide following value:
   ...
   * Gateway Subnet Prefix: `10.0.1.0/27`
   > Now click on **Review + create** botton.
...
15. You are now successfully RDP to the **JumpBox** virtual machine.

16. Close Server Manager window by clicking the "X" button in the top-right corner of the window.
