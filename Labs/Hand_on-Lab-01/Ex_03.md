...
7. In the **NSX-T Console**, click **Networking**. Select **DHCP** under management and click on **ADD DHCP PROFILE**.

   ![DHCP PROFILE](../Images/task2.5.jpg)

8. On the DHCP profile page provide the following details and **Save (4)**.
...
9. The **DHCP profile** has been added successfully.
...
4. Select **NO** on the **Tier-1 Gateway Lab-T1** is successfully created.
...
5. Select **NO** on the **Segment Web-Segment is successfully created.**
