...
14. Open a new tab in the egde browser and nevigate to `https://developer.microsoft.com/en-us/windows/downloads/virtual-machines/`
...
15. Under **Get a Windows 11 development environment** click on **VMware** which will download a zip file named **WinDev2401 Eval.VMWare.zip**.
    ...
    >**Note**: Wait for the file to get download it will take upto 30 mins.
...
17. Wait until file extration completed.
...
3. Under **Import Library Item tab**, click on **Local files** and  select the **files you just extrated** in previous and click on Open.
  
    ![](../Images/4.1.1.png)

4. Item name as **workshop-vm** then click on **IMPORT (2)**.

   ![](../Images/4.1.png)

5. Once the import is completed, you will see a warning message as **SSL certification from server gpsusstorage.blob.core.windows.net can not be trusted. Do you want to proceed**. Click on **Actions** and then **Continue**.

   ![](../Images/3.13.jpg)

6. You will see the **workshop-vm (3)** under the **OVF & OVA Templates (2)**.
...
1. Right click on **workshop-vm (1)**, and then select **New VM from This Template... (2)**.
   ...
   >**Note**: Wait for 24 hours to get **New VM from This Template...** option .
...
8. Repeat the above steps and create a new VM with name **TestVM-2**.
