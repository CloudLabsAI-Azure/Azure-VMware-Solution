...
6. Log in to the **VMware vSphere**; Enter the **Username** and **password** of vCenter Server credentials that you copied in step 3 and click on **LOGIN**.
...
4. Next, enter the VM username and password as below and then provide new password to which you want to change the existing password.
