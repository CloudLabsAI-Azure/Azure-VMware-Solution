...
3. Under **Import Library Item tab**, enter the source file URL as `https://github.com/CloudLabsAI-Azure/Azure-VMware-Solution/blob/avs-2024/artifacts/WinDev2401Eval.ovf` **(1)** and click on **IMPORT (2)**.
